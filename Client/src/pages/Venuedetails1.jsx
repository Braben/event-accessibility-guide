...
const Venuedetails1 = () => {
    ...
    overview: (
      <div className="mt-4 my-5">
        ...
        <p className="mt-6 text-sm">
          A fully accessible arts venue with regular exhibitions and performances. The center features multiple 
          gallery spaces, a theater, and workshop areas for community art programs.
        </p>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-5 mt-6'>
          <div className='flex bg-gray-100 h-20 p-4 gap-4 rounded-lg'>
            ...
            <div>
              ...
              <p className='text-sm mt-1'>Ramps and wide doorways throughout venue</p>
            </div>
          </div>
          ...
          <div className='flex bg-gray-100 h-20 p-4 gap-4 rounded-lg'>
            ...
            <div>
              ...
              <p className='text-sm mt-1'>ADA-compliant restrooms on all floors</p>
            </div>
          </div>
          ...
          <div className='flex bg-gray-100 h-20 p-4 gap-4 rounded-lg'>
            ...
            <div>
              ...
              <p className='text-sm mt-1'>Elevators to all levels of the venue</p>
            </div>
          </div>
          ...
          <div className='flex bg-gray-100 h-20 p-4 gap-4 rounded-lg'>
            ...
            <div>
              ...
              <p className='text-sm mt-1'>Designated accessible spaces near entrance</p>
            </div>
          </div>
          ...
          <div className='flex bg-gray-100 h-20 p-4 gap-4 rounded-lg'>
            ...
            <div>
              ...
              <p className='text-sm mt-1'>Braille signage and high contrast displays</p>
            </div>
          </div>
          ...
          <div className='flex bg-gray-100 h-20 p-4 gap-4 rounded-lg'>
            ...
            <div>
              ...
              <p className='text-sm mt-1'>Hearing loop system in main theater</p>
            </div>
          </div>
        </div>
    ...
    reviews: (
      <div className="py-6">
        ...
        <div className="border rounded-lg p-4 mb-4">
          ...
          <p className="text-sm text-gray-600 mt-1">Visited on March 12, 2025</p>
          <p className="mt-2">
            Amazing venue! The staff was extremely helpful and the space was perfect for our company retreat.
        ...
        <div className="border rounded-lg p-4 mb-4">
          ...
          <p className="text-sm text-gray-600 mt-1">Visited on February 28, 2025</p>
          <p className="mt-2">
            Good location but parking was a challenge. The venue itself was clean and well-maintained.
            Sound system could use an upgrade.
          </p>
        </div>
        ...
        <div className="grid gap-4">
                       <div className="border rounded p-4 hover:shadow-md transition-shadow">
                         <div className="flex justify-between items-start">
                           <div>
                             <h3 className="font-semibold text-lg">Abstract Art Exhibition</h3>
                             <div className='flex gap-2 mt-1'><CiClock2  className='text-blue-700 mt-[2px]'/><p className="text-sm ">Mon -Fri : 9am-9pm ,Sat -Sun : 10am-8pm</p></div> 
                             <div className='flex gap-2 mt-1'><SlCalender className='text-blue-700'/><p className="text-sm ">Upcoming events : 4</p></div>
                           </div>
                       ...
                       <div className="border rounded p-4 hover:shadow-md transition-shadow">
                         <div className="flex justify-between items-start">
                           <div>
                             <h3 className="font-semibold text-lg">Community Theater Performance</h3>
                             <div className='flex gap-2 mt-1'><CiClock2  className='text-blue-700 mt-[2px]'/><p className="text-sm ">Mon -Fri : 9am-9pm ,Sat -Sun : 10am-8pm</p></div> 
                             <div className='flex gap-2 mt-1'><SlCalender className='text-blue-700'/><p className="text-sm ">Upcoming events : 4</p></div>
                           </div>
  ...
  return (
    <div className="container mx-auto px-4 max-w-6xl">
      ...
      {/* Back Button */}
      <div className="mt-6">
        <Link to="/venue" className="flex items-center text-blue-800 font-medium">
      ...
      <div className="relative mt-4">
        <img 
          src="https://s3-alpha-sig.figma.com/img/fb68/24e5/442ee0854ceb471149eea96ea69fea05?Expires=1743984000&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=JhXXNhDsPRMhtDse5fjcJBiNIvvmKMKpkXh5u-bzacnrWXdmB0BxbeW~2vpK~8fFmR1YYkSFX8Kj0Yktw-IGazG7vzwteHtRhmR~mqK-NWggsFSGtGaivlhO9LjAJfD~jzMdAE~OxEDcih1gzJD2mEhiUckWw9yl7saMjD-OIxogsL4DrXqNlbkl3qL6YoKIzw8C-FJbJLjTn1snCdbWo6eJoydzN0C22jnPligJZzJLShFzfdZdf7GOZRUnAxSlBK1uC41~2v0oA9cyi1JG-WhChMvvX0-f4NpJmsv16qJLMIzN3Lk-15mrG4bgWBxRPNB8yIDmQT3Z8-sYlaFzqg__" 
          alt="The Savannah" 
        ...
        <div className="absolute bottom-0 left-0 p-6 text-white w-full bg-gradient-to-t from-black/70 to-transparent rounded-b-lg">
          <h1 className="text-3xl md:text-4xl font-bold">The Savannah</h1>
          <div className="flex items-center mt-2">
            <CiLocationOn className="mr-1" />
            <p className="text-lg">90 Giffard Rd, East Cantonments, Accra</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row md:justify-between items-center mt-6">
        ...
        <FaStar className='text-[#E39000] mt-[2px]'/> <p className="font-medium">4.5 (120 reviews)</p>
        </div>
        ...
        <div className="w-full md:w-1/3 mt-8 md:mt-[70px]">
          ...
          <div className="bg-white shadow rounded-lg p-4 mb-4">
            ...
            <div className="flex items-center mt-3">
              ...
              <p className="text-sm">+233 245480345</p>
            </div>
            <div className="flex items-center mt-3">
          ...
          <div className="bg-white shadow rounded-lg p-4 mb-4">
            ...
            <p className="text-sm mt-4 text-center">90 Giffard Rd, East Cantonments, Accra</p>
          ...
          <div className="bg-white shadow rounded-lg p-4">
            ...
            <div className="bg-blue-100 rounded-lg p-3 flex items-center mt-4">
              ...
              <p className="text-sm">This venue has been verified for accessibility features by our team.</p>
            </div>
            <div className="bg-yellow-100 rounded-lg p-3 flex items-center mt-3">
              <MdErrorOutline className="text-yellow-600 text-xl mr-2" />
              <p className="text-sm">Please contact venue for specific accessibility accommodations.</p>
            </div>
          </div>
        </div>
      </div>
