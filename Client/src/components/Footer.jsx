    ...
    <footer className="bg-[#1E1E1E] text-white py-13  h-[390px] mt-30">
      <div className="max-w-7xl mx-auto px-4 flex flex-col  md:flex-row items-center justify-between">
        ...
        <div className="flex flex-col  mt-4 md:mt-0 ">
             <Link to="/" className="font-bold text-xl text-white">VenueHubs</Link>
        ...
        <div className="flex flex-col gap-4 mt-4 md:mt-0">
         ...
         <p className='flex gap-2'><BsTelephone className='mt-1'/>+233 245480345</p>
         ...
         <p className='flex gap-2 cursor-pointer'><MdOutlineLocationOn className='mt-1 text-2xl ' />Accra,Ghana</p>
        </div>
        
      </div>
      <div className='h-[1px] w-full bg-blue-500 mt-20 '></div>
      <p className='flex gap-2  ml-10 mt-5'>< FaRegCopyright className='mt-1'/>2025 AccessMap.All rights reserved</p>
